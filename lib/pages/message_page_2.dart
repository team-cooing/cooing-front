...
class MessagePage2 extends StatefulWidget {
  ...
  const MessagePage2({super.key, required this.user, required this.answers});

  @override
  State<MessagePage2> createState() => _MessagePage2State();
}

class _MessagePage2State extends State<MessagePage2> {
